          ...
          */}
          <div className="px-6 py-5 flex flex-col gap-5">
            ...
            <TimelineItem
              ...
              description="The token your pool is paired with must itself have a valid Chainlink feed in the contract. USDC and USDT are pre-configured — all others must be added manually."
            />
            <TimelineItem
              code="2F"
              palette="cyan"
